...
# Deploy Reporter Service to Cloud Run using Artifact Registry
...
echo_info "Deploying Reporter to Cloud Run..."
...
SERVICE_VERSION=$VERSION \
    --labels service=reporter,version=${VERSION//[^a-zA-Z0-9]/-} \
    --project $PROJECT_ID
...
echo_info "Reporter deployed successfully!"
